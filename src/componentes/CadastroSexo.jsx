...
/**
 */
export default class CadastroSexo extends React.Component {
   ...
   */
  getMsgExcluir() {
    return `Tem certeza que deseja excluir o Sexo: "
  ...
  async getRegistros(f, range) {
    ...
    const ret = await Api.getRegistrosPaginacaoCodNomeTab('sexo', 'descricao', 'cod_sexo', filtro);
    if (!ret.status) {
          ...
          <div className="row col-sm-12">
            ...
            <div className="col-sm-2">
              <LabeledInput label="Código:"
                            ...
                            onChange={this.onChange.bind(this, 'cod_sexo')} />
            </div>
  ...
  render() {
    return (
      <Cadastro tabela="tab_sexo"
        pk="cod_sexo"
        titulo="Cadastro de Sexo"
        subTitulo="Configure os seus Sexos!"
